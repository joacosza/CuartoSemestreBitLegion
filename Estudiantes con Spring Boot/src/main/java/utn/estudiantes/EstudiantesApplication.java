...
public class EstudiantesApplication implements CommandLineRunner {
    ...
    private boolean ejecutarOpciones(Scanner consola){
        ...
        switch (opcion){//Listar estudiantes
            ...
            case 2 -> {//Buscar estudiante poe id
                ...
                if(estudiante != null)
                    ...
                    logger.info("Estudiante NO esncontrado: "+ estudiante + nl);
            }
            ...
            case 4 -> {//Modificar estudiante
                ...
                if(estudiante != null){
                    ...
                    logger.info("Estudiante NO encontrado en el id: "+ idEstudiante+nl);
            }
            case 5 -> {//Eliminar estudiante
                logger.info("Eliminar estudiante: "+nl);
                logger.info("igite el id estudiante: ");
                var idEstudiante = Integer.parseInt(consola.nextLine());
                //Buscamos el id estudiante a eliminar
                var estudiante = estudianteServicio.buscarEstudiantePorId(idEstudiante);
                if(estudiante != null){
                    estudianteServicio.eliminarEstuiante(estudiante);
...
}//Fin class EstudiantesAplication